...
<section class="breadcrumbs">
  <div class="container">
    ...
    <div class="container">
        ...
        <p>• the recitation of the wirds (litanies) of the order,</p>

        <p>• the wazifa (office),</p>

        <p>• participation in the hadra (seance) on Friday.</p>

        The wirds are performed twice daily, (morning and evening) and consist of:

        <p>• recitation of the formula of penitence Astaghfiru Allah(5) 100 times.</p>

        <p>• saying a prayer for the Prophet, preferably in the form of the Tijani prayer Salat al-Fatih(6) 100 times.</p>

        <p>• reciting the formula of the Hailalah, La Ilaha illa Allah(7) 100 times.</p>
        ...
        <p>• reciting the formula of penitence, Astaghfiru Allah al-'Azim al-ladhi la Ilaha illa huwa al-hayy al-qayyum(9) 30 times.</p>

        <p>• reciting Salat al-Fatih 50 times.</p>

        <p>• saying the Hailalah 100 times.</p>

        <p>• reciting the prayer called Jawharat al-Kamal(10) 12 times.</p>
        ...
        The hadra (or dhikr) takes place on Friday after the Tijanis have communally performed the afternoon prayer, and wazifa. The Tijani hadra mainly consists of repeating in unison La Ilaha illa Allah, or merely Allah, Allah.... This may be recited between 1,000 or 1,600 times(11).
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        Designed by <a href="https://tijjaniyya.com/">Tijjaniyya</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="{{ asset('styles/assets/jquery/jquery.slim.min.js') }}"></script>
  <script src="{{ asset('styles/assets/js/popper.min.js')}}"></script>
  <script src="{{ asset('styles/assets/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('styles/assets/maincss/bootstrap_5/js/bootstrap.bundle.min.js') }}"></script>
