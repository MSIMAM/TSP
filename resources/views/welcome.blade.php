...
<head>
    ...
    <meta name="author" content="Tijjaniyya sufi path">
                ...
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                        ...
                        <div class="content">
                            <h3>Who We Are</h3>
                            <p>
                                We Are Student Seeking Knowledge And Trying To Contribute In The Journey Of Tharikha
                                Tijjaniyyah.
                            </p>
                            <div class="text-center text-lg-start">
                                <a href="#hero"
                    ...
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                        <img src="{{ asset('styles/assets/img/abouts.jpg') }}" class="img-fluid rounded"
                            alt="">
                    </div>
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-1.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-2.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-3.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-4.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-5.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-6.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-7.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('styles/assets/img/clients/client-8.png') }}"
                                class="img-fluid" alt=""></div>
                    </div>
                </div>
    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>The first level is Islam. A Muslim must be declared that there is no God but Allah and
                                Muhammad (SAW) is the messenger of Allah (SWT). By declaring this a person accepts the
                                message of Allah Almighty that is revealed to humanity through the last prophet Muhammad
                                (SAW).</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Iman or faith is the first thing that we have to learn in our religion because it acts as
                                our roots. Iman is basically to believe in Allah, His Angels, His Books, His Messengers
                                and all the scriptures which He sent down before.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Ihsan is the highest status of religion Islam. Its definition that our beloved Prophet
                                Muhammad (SAW) described is: “To worship Allah as if you see Him, and if you do not see
                                Him, He sees you.”</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('styles/assets/img/schollars/abouts.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Sheikh Ahmad Tijjani</h4>
                                <p>(R.T.A)</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('styles/assets/img/schollars/abouts.jpg') }}"
                                        data-gallery="portfolioGallery" class="portfokio-lightbox" title="Sheikh"><i
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>(R.T.A)</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('styles/assets/img/portfolio/abouts.jpg') }}"
                                        data-gallery="portfolioGallery" class="portfokio-lightbox" title="Sheikh"><i
                                            class="bi bi-plus"></i></a>
                                    <a href="portfolio-details.html" title="More Details"><i
                                            class="bi bi-link"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    <a href="{{ asset('styles/assets/img/schollars/abouts.jpg') }}"
                                        data-gallery="portfolioGallery" class="portfokio-lightbox" title="Shaikh"><i
                                            class="bi bi-plus"></i></a>
                                    <a href="portfolio-details.html" title="More Details"><i
                                            class="bi bi-link"></i></a>
                                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    ...
                                    First I Pray for wealth later i realised that it does not last. Then I asked for
                                    mercy. But realised that also does'nt last. I concluded that if a person would
                                    remain free of wants and needs he should ask only for allah him self.
                                    May Allah give us Allah , Anything Else that He gives other than himself will come
                                    to pass. And as his vicegerents, we are bound to always be in need of Him, May Allah
                                    give us Allah.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                                <div class="profile mt-auto">
                                    <img src="{{ asset('styles/assets/img/qoutes/book.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    ...
                                    And arrogance arises because either because of Knowledge, lineage or companionship
                                    or getting involved in acts of devotions and wealth.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                                <div class="profile mt-auto">
                                    <img src="{{ asset('styles/assets/img/qoutes/book.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Teach your wives and your children that loving the neighbours, the members of the
                                    community and living peacefully with the creation is greater worship.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                                <div class="profile mt-auto">
                                    <img src="{{ asset('styles/assets/img/qoutes/book.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    Everything you desire exists with allah -- so if you have Allah you have everything
                                    you desire. If you don't have Allah, then nothing you desire will make you happy
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                                <div class="profile mt-auto">
                                    <img src="{{ asset('styles/assets/img/qoutes/book.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                    The (Prophet) who eradicate the darkness of polytheism is enough eradicator of my
                                    worries.
                                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                                </p>
                                <div class="profile mt-auto">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="post-box">
              <div class="post-img"><img src="{{ asset('styles/assets/img/blog/blog.png')}}" class="img-fluid" alt=""></div>
        ...
        <div class="footer-top">
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        <h4>Our Mission</h4>
                        <p>Our Mission is to enlighten the whole muslim ummah on what's the true mean of tharikha
                            tijjaniyya. </p>
