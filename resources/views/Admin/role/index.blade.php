...
<div class="page-wrapper">
    <div class="content">
            <div class="page-header">
                ...
                <div class="page-btn">
                    @can('Role create')
                        <a class="btn btn-added" href="#" data-bs-toggle="modal" data-bs-target="#create_role"><img src="{{asset('styles/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Roles</a>
                    @endcan
                </div>
            </div>
            <div class="card">
                            ...
                            <tbody>
                                ...
                                @foreach($roles as $role)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @can('Role edit')
                                                <a class="me-3" data-bs-target="#edit_role{{$role->id}}" data-bs-toggle="modal">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.roles.update',$role->id)}}" method="POST">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input class="form-control" name="name" value="{{ old('name', $role->name)}}" type="text">
                                                        </div>
                                                    </div>
